async function debugBobTasksApi() {
    console.log('Debugging Bob tasks via API...');
    ...
    try {
        ...
        // Get tasks via /me/tasks
        const tasksResponse = await fetch('http://localhost:3001/api/students/me/tasks', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
